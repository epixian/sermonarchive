...
<!--
        <div class="pt-4 pb-3 border-t border-gray-200">
            ...
            <div class="mt-3" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                ...
                <a href="#" class="mt-1 block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 focus:outline-none focus:text-gray-800 focus:bg-gray-100 transition duration-150 ease-in-out" role="menuitem">{{ __('Logout') }}</a>
            </div>
        </div>
-->
    </div>
