    ...
    <transition
      ...
      <div v-if="open" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg z-50">
        <div class="pb-1 rounded-md bg-white shadow-xs">
          ...
          <div>
            <a href="/logout" @click.prevent="logout" class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">Log out</a>
          </div>
        </div>
      </div>
    </transition>
